...
namespace  exqudens::bitcoin::miner {

    class EXQUDENS_BITCOIN_MINER_EXPORT Sha256 {

        private:

            inline static const std::array<uint32_t, 64> K = {
        ...
        public:
            ...
            std::array<uint8_t, 32> convert(const uint8_t* data, size_t length);
